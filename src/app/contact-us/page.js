        ...
        <div className="grid grid-cols-1 mb-5 lg:grid-cols-4 gap-5 lg:gap-8">
          ...
          <div className="col-span-3 order-1 lg:order-2 p-4 lg:p-5  border rounded-md">
            <form>
              ...
              <textarea
                className="w-full border outline-blue-500 rounded-md px-3 py-2 bg-[#F5F5F5]"
                name="message"
              ...
              <div className="my-2 text-right">
                <button className="text-primaryPurple border-primaryPurple py-2 px-5 border rounded-md ">
                  Send Message
                </button>
              </div>
            </form>
